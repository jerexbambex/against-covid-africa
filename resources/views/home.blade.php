...
<div x-data="{ open: false }" class="relative bg-white overflow-hidden mt-0">
      ...
      <div class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="sm:text-center lg:text-left">
          ...
          <h2 class="font-boing font-light text-4xl tracking-normal leading-10 text-gray-900 sm:text-3xl sm:leading-none md:text-4xl">
            Against CIVID-19
            <br class="xl:hidden" />
            <span class="text-indigo-600">Africa</span>
          </h2>
  ...
  <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full translate-x-1/2" fill="currentColor" src="img/svgs/Linth.svg" alt="" />
  </div>
</div>
