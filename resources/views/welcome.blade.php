...
<div x-data="{ open: false }" class="relative bg-white overflow-hidden mt-0">
    ...
    <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
        ...
        {{-- <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
          ...
          <div class="hidden md:block md:ml-10 md:pr-4">
            ...
            <a href="#" class="ml-8 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">Company</a>
              ...
              @csrf
              <a href="{{ route('logout') }}" class="ml-8 font-medium text-indigo-600 hover:text-indigo-900 focus:outline-none focus:text-indigo-700 transition duration-150 ease-in-out">Logout</a>
            </form>
          </div>
        </nav> --}}
      </div>
      ...
      <div class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="sm:text-center lg:text-left">
          <img class="sm:h-72 md:h-96 sm:object-center lg:h-full" src="img/logos/logo-white.png" alt="Fegocoosa">
            <br>
          <h2 class="font-boing font-light text-4xl tracking-normal leading-10 text-gray-900 sm:text-3xl sm:leading-none md:text-4xl">
            Fegocoosa
            <br class="xl:hidden" />
            <span class="text-indigo-600">Official Website</span>
          </h2>
          <p class="font-montserrat mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
  ...
  <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="img/eoy.jpg" alt="" />
  </div>
</div>
...
<div class="py-12 bg-white">
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="lg:text-center">
      ...
      <p class="mt-4 max-w-2xl text-md leading-7 text-gray-700 lg:mx-auto">
      ...
      <ul class="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
        <li>
          <div class="flex">
            ...
            <div class="ml-4">
              <h5 class="text-md leading-6 font-medium text-gray-900">Competitive exchange rates</h5>
              <p class="mt-2 text-xs text-base leading-6 text-gray-500">
        ...
        <li class="mt-10 md:mt-0">
          <div class="flex">
            ...
            <div class="ml-4">
              <h5 class="text-md leading-6 font-medium text-gray-900">No hidden fees</h5>
              <p class="mt-2 text-sm text-base leading-6 text-gray-500">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.
              </p>
            </div>
          </div>
